...
void initializeMetaData()
{
    ...
    ProxyControl::registerMetaData(css::CSSRuleList::getMetaData(), Proxy_Impl<ProxyObject, css::CSSRuleList_Bridge<Any, invoke> >::createInstance);
    ...
    ProxyControl::registerMetaData(stylesheets::DocumentStyle::getMetaData(), Proxy_Impl<ProxyObject, stylesheets::DocumentStyle_Bridge<Any, invoke> >::createInstance);
    ...
    ProxyControl::registerMetaData(stylesheets::StyleSheetList::getMetaData(), Proxy_Impl<ProxyObject, stylesheets::StyleSheetList_Bridge<Any, invoke> >::createInstance);
